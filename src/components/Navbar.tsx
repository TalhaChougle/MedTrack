        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 border-b border-slate-100">
          <div className="flex items-center justify-between h-14 gap-4">
            ...
            <div className="flex md:hidden items-center gap-1.5 shrink-0">
              <button
                onClick={() => handleOpenScanner("check")}
                className="px-2 py-1.5 rounded-xl bg-slate-100 text-[#1E3A5F] border border-slate-200 text-xs font-extrabold flex items-center gap-1 cursor-pointer whitespace-nowrap shrink-0"
                title="Check Stock"
              >
                <QrCode className="w-3.5 h-3.5 text-[#1E3A5F]" />
                <span className="text-[11px] whitespace-nowrap">Check</span>
              </button>

              <button
                onClick={() => handleOpenScanner("stockIn")}
                className="px-2.5 py-1.5 rounded-xl bg-teal-600 hover:bg-teal-700 text-white text-xs font-extrabold flex items-center gap-1 shadow-sm cursor-pointer whitespace-nowrap shrink-0"
                title="Stock In Delivery"
              >
                <Boxes className="w-3.5 h-3.5 text-white" />
                <span className="text-[11px] whitespace-nowrap">Stock In</span>
              </button>
